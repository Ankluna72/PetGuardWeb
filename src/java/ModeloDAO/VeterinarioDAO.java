...
public class VeterinarioDAO implements CRUDVeterinario {
    ...
    public boolean add(Veterinario vet) {
        ...
        try {
            con = cn.getConnection();
            String sql = "INSERT INTO tbVeterinario (dni, nombre, apellidos, correo, telefono, direccion, foto, contra) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            ps = con.prepareStatement(sql);
            ...
            ps.setString(7, vet.getFoto());
            ps.setString(8, vet.getContra());
